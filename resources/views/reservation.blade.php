                            ...
                            <div id="jqueryModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50">
                                ...
                                <div id="modalBox" class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 scale-95 opacity-0 fade-in">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <div id="cancelModal" class="cursor-pointer"><i data-lucide="x"></i></div>
                                    </div>
                                    <!-- radio -->
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <div class="">
                                                ...
                                                <label class="peer-checked:border-2 peer-checked:border-blue-400 peer-checked:bg-blue-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4 pr-20" for="radio_1">
                                                    <img src="{{ asset('img/paystack.png') }}" class="w-14" alt="">
                                                    <div class="ml-5">
                                            ...
                                            <div class="">
                                                ...
                                                <label class="peer-checked:border-2 peer-checked:border-blue-400 peer-checked:bg-blue-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4 pr-20" for="radio_2">
                                                    <img src="{{ asset('img/mastercard.png') }}" class="w-14" alt="">
                                                    <div class="ml-5">
