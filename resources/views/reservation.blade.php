                ...
                <div class="space-y-10">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="text" placeholder="First Name" class="border rounded-md px-3 py-2 w-full">
                            <input type="text" placeholder="Last Name" class="border rounded-md px-3 py-2 w-full">
                        </div>

                        <input type="text" placeholder="Phone No" class="border rounded-md px-3 py-2 w-full mt-4">

                        <input type="email" placeholder="Email" class="border rounded-md px-3 py-2 w-full mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h2 class="text-lg font-semibold">Choose Train</h2>
                        </div>
                ...
                <div>
                    ...
                    <div class="border rounded-xl bg-white p-6 shadow-sm relative">
                        ...
                        <div class="text-sm space-y-1">
                            ...
                            <p><strong>Coach</strong> &nbsp;&nbsp;<span id="coachB"></span></p>
                            <p><strong>Seat number</strong> &nbsp;&nbsp; —</p>
                            <p><strong>Departure Station</strong> &nbsp;&nbsp; AGBARHO</p>
                            <p><strong>Arrival Station</strong> &nbsp;&nbsp; AGENEBODE</p>
                            <p><strong>Departure Time</strong> &nbsp;&nbsp; 08:21AM</p>
                            <p><strong>Arrival Time</strong> &nbsp;&nbsp; 11:20AM</p>
                            <p><strong>Trip Session</strong> &nbsp;&nbsp; Morning</p>
                            <p><strong>Email</strong> &nbsp;&nbsp; raphealmary772@gmail.com</p>
                            <p><strong>Phone number</strong> &nbsp;&nbsp; 0901 942 6074</p>
                            <p><strong>Full name</strong> &nbsp;&nbsp; Rapheal Onyeke</p>
                        </div>
                        ...
                        <div class="mt-6 bg-green-700 text-white p-5 rounded-lg text-center">
                            <p class="text-sm mb-2">1 seat (Adult) × ₦5,000.00</p>
                            <p class="text-sm mb-4">Convenience Fee (6.5% OF Ticket fee) ₦325.00</p>
                            <p class="text-3xl font-bold">₦5,325.00</p>
                        </div>

                        <button class="mt-5 w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg text-lg">
                            Pay Now
                        </button>
